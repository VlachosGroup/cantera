//! @file GasOnlyReactor.h

// This file is part of Cantera. See License.txt in the top-level directory or
// at http://www.cantera.org/license.txt for license and copyright information.

#ifndef CT_GASONLYREACTOR_H
#define CT_GASONLYREACTOR_H
...
/**
 * Class GasOnlyReactor is a class for stirred reactors that is specifically
 * optimized for ideal gases. In this formulation, temperature replaces the
 * total internal energy as a state variable.
 */
class GasOnlyReactor : public Reactor
{
public:
    GasOnlyReactor() {}

    virtual int type() const {
        return GasOnlyReactorType;
    }
